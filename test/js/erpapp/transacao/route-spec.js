describe('Transacao Routes: ', function() {
    beforeEach(module('erpapp.transacao'));
	...
	describe('Index route: ', function() {
		beforeEach(inject(
			function($httpBackend) {
				...
				$httpBackend.whenGET('/api/transacao').respond([]);
				$httpBackend.whenGET('/api/empresa').respond([]);
			}
		));
	...
	describe('Create route: ', function() {
		beforeEach(inject(
			function($httpBackend) {
				...
				$httpBackend.whenGET('/api/transacao/create').respond([]);
				$httpBackend.whenGET('/api/empresa').respond([]);
			}
		));
	...
	describe('Edit route: ', function() {
		beforeEach(inject(
			function($httpBackend) {
				$httpBackend.whenGET('create-edit.html').respond(200, 'list page');
				$httpBackend.whenGET('/api/transacao/1').respond([]);
				$httpBackend.whenGET('/api/empresa').respond([]);
			}
		));
