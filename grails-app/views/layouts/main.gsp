...
<body class="skin-blue sidebar-mini" id="ng-app" ng-app="${pageProperty(name: 'body.ng-app') ?: 'grails'}">
  ...
  <asset:script type="text/javascript">
    angular.module('grails.constants') .constant('rootUrl', '${request.contextPath}') .constant('pageSize', ${grailsApplication.config.angular.pageSize}) .constant('dateFormat', '${grailsApplication.config.angular.dateFormat}');
  </asset:script>
  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <sec:ifLoggedIn>
            ...
            <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_CONTASRECEBER, ROLE_CONTASPAGAR">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_CONTASPAGAR">
                    <li>
                      <g:link uri="/transacao#/">Contas a Pagar</g:link>
                    </li>
                  </sec:ifAnyGranted>
                  <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_CONTASRECEBER">
                    <li>
            ...
            <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_ESTOQUE">
    ...
    <aside class="control-sidebar control-sidebar-dark">
      ...
      <div class="tab-content">
        ...
        <!-- /.tab-pane -->
        <!-- Stats tab content -->
        <div class="tab-pane" id="control-sidebar-stats-tab">Setar conteúdo aqui</div>
        <!-- /.tab-pane -->
